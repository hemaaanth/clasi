...
- Added the OMP extension, `/clasi` review surface, bundled operating skill, and provider-free `clasi` CLI.
- Added scoped Context, Napkins, and Papercuts with bounded injection, explicit proposals, impact reporting, and local Markdown storage.
